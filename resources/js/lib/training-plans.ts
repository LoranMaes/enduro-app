...
const mapSession = (session: TrainingPlanApi['training_weeks'][number]['training_sessions'][number]): TrainingSessionView => {
    return {
        id: session.id,
...
const mapWeek = (week: TrainingPlanApi['training_weeks'][number]): TrainingWeekView => {
    return {
        id: week.id,
