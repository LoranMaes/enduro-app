...
export function SessionInternalNotes({
    ...
    return (
        <div className="mt-3">
            ...
            <div className="mt-2 flex items-center justify-between gap-3">
                ...
                {canEditNotes ? (
                    <button
                        ...
                        onClick={onSave}
                        className={cn(
                            'inline-flex items-center gap-1 rounded border px-2 py-1 text-[0.6875rem] transition-colors',
            ...
            {notesError !== null ? (
                <p className="mt-2 rounded-md border border-red-500/25 bg-red-500/10 px-2.5 py-1.5 text-[0.6875rem] text-red-300">
                    {notesError}
                </p>
            ) : null}
        </div>
