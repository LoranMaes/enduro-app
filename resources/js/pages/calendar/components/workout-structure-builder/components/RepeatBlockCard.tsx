        ...
        >
                    ...
                    <div className="flex items-center rounded border border-zinc-700 bg-zinc-900/80">
                        <button
                            ...
                            onClick={() => {
                                onUpdateStep({
                                    ...step,
                                    repeatCount: Math.max(2, step.repeatCount - 1),
                                });
                            }}
            ...
            <div className="mt-2 space-y-2">
                ...
                <button
                    ...
                    disabled={disabled}
                    onClick={onAddItem}
                    className="inline-flex items-center gap-1 rounded border border-zinc-700 bg-zinc-900/60 px-2 py-1 text-[0.625rem] text-zinc-300 transition-colors hover:bg-zinc-800 disabled:opacity-50"
                >
                    <Plus className="h-3 w-3" />
                    Add repeat item
                </button>
