...
class IdMigrationMap
{
    ...
    public function foreignUuidRelationships(): array
    {
        return [
            ...
            ['table' => 'tickets', 'column' => 'reporter_user_id', 'uuid_column' => 'reporter_user_uuid_id', 'parent_table' => 'users'],
            ...
            ['table' => 'ticket_messages', 'column' => 'ticket_id', 'uuid_column' => 'ticket_uuid_id', 'parent_table' => 'tickets'],
            ['table' => 'ticket_messages', 'column' => 'author_user_id', 'uuid_column' => 'author_user_uuid_id', 'parent_table' => 'users'],
            ...
            ['table' => 'ticket_attachments', 'column' => 'uploaded_by_user_id', 'uuid_column' => 'uploaded_by_user_uuid_id', 'parent_table' => 'users'],
