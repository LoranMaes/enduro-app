    ...
    public function __invoke(Request $request): Response|RedirectResponse
    {
        ...
        return Inertia::render('settings/overview', [
            ...
            'trainingPreferences' => [
                ...
                'lt1_power_watts' => $resolvedPerformanceProfile['lt1_power_watts'],
                'lt2_power_watts' => $resolvedPerformanceProfile['lt2_power_watts'],
                'max_heart_rate_bpm' => $resolvedPerformanceProfile['max_heart_rate_bpm'],
                'lt1_heart_rate_bpm' => $resolvedPerformanceProfile['lt1_heart_rate_bpm'],
                'lt2_heart_rate_bpm' => $resolvedPerformanceProfile['lt2_heart_rate_bpm'],
