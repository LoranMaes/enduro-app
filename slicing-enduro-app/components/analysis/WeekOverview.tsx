...
export const WeekOverview: React.FC<WeekOverviewProps> = ({ week, onBack }) => {
    ...
    const [viewMode, setViewMode] = useState<'overview' | 'analysis' | 'edit'>(
        'overview',
    );
    ...
    return (
        <div className="flex h-full animate-in flex-col bg-background duration-300 fade-in">
            {/* Sticky Header */}
            ...
            <div className="flex-1 overflow-y-auto">
                <div className="mx-auto max-w-6xl p-6">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                        ...
                        <div className="space-y-8 lg:sticky lg:top-6 lg:col-span-4 lg:h-fit">
                            <WeeklyLoadSummary
